...
def fight_menu(uid, msg):  # Все что связано с взаимодействием в бою
    ...
    if msg == GO_AHEAD:
        ...
        bot.send_sticker(uid, user.enemy.sticker)
...
def new_level(uid, msg):  # получение нового уровня( условия, кнопки выбора характеристик повышение параметров героя)
    ...
    elif msg == "Сила 💪 +2":  # если выбран параметр Сила +2
        user.addpower(1)  # повышение силы на 2
    elif msg == "Защита 🛡 +2":  # если выбран параметр Защита +2
        user.defence += 1  # повышение защиты персонажа на 2
